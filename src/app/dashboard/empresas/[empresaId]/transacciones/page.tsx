...
interface EmpresaTransaccionesDashboardPageProps {
  params: { empresaId: string };
}

export default async function EmpresaTransaccionesDashboardPage({ params }: EmpresaTransaccionesDashboardPageProps) {
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-semibold text-foreground">Transacciones</h2>
         <Button asChild size="sm" variant="outline">
            {/* Ruta actualizada */}
            <Link href={`/dashboard/empresas/${empresaId}/cuentas`}> 
