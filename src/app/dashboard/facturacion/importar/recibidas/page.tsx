...
export default function ImportarFacturasRecibidasPage() {
  ...
  const handleSaveFacturas = async () => {
    ...
    try {
      ...
      router.push('/dashboard/facturacion/recibidas');
    } catch (error) {
  ...
  return (
    <div className="container py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold ml-4">Importar Facturas Recibidas</h1>
      </div>
          ...
          <>
            <div className="mb-6">
              <p className="text-sm text-muted-foreground mb-4">
                Importa facturas recibidas de tus proveedores. Estas facturas aparecerán en la sección "Facturas Recibidas".
              </p>
            </div>
