...
interface EmpresaCuentasPageProps {
  params: { empresaId: string };
}

export default async function EmpresaCuentasPage({ params }: EmpresaCuentasPageProps) {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button asChild size="sm">
          <Link href={`/empresas/${empresaId}/cuentas/nueva`}>
            ...
            <Card key={account.id} className="flex flex-col justify-between hover:shadow-md transition-shadow">
              <CardHeader>
                <div className="flex items-center justify-between">
                    ...
                    {/* Placeholder for quick actions like edit/delete in future */}
                </div>
              ...
              <CardFooter className="flex justify-between items-center">
                ...
                <Button asChild variant="outline" size="sm">
                  <Link href={`/empresas/${empresaId}/cuentas/${account.id}/importar`}>
                    Importar Cartola
                  </Link>
                </Button>
              </CardFooter>
